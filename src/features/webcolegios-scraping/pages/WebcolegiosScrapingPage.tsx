...
import type { WebcolegiosRobotStatus } from '../model/types';
...
const ROBOT_STATUS_DETAIL: Record<WebcolegiosRobotStatus, string> = {
  no_connected: 'El robot esta listo para iniciar una nueva conexion.',
  connecting: 'Validando conexion con la plataforma WebColegios.',
  running: 'Extrayendo estudiantes, docentes y documentos asociados.',
  syncing: 'Enviando resultados al proceso de sincronizacion.',
...
export const WebcolegiosScrapingPage = () => {
  ...
  return (
    <div className="webcolegios-page">
      <main className="webcolegios-main">
        <header className="webcolegios-hero">
          <div className="webcolegios-hero-copy">
            <div className="webcolegios-kicker">Robot institucional</div>
            <h1>Scraping WebColegios - New Cambridge School</h1>
            <p>Conexion y sincronizacion de estudiantes y docentes desde WebColegios.</p>
          </div>
          <div className="webcolegios-robot-hero" aria-hidden="true">
            <Bot />
          </div>
        </header>

        <section className="webcolegios-info-band">
          <p>
        ...
        <div className="webcolegios-tabs" role="tablist" aria-label="Modulo WebColegios">
          {TABS.map((tab) => (
            <button
            ...
            <div className="webcolegios-grid">
              ...
              >
                ...
                <div className="webcolegios-status-footer">
                  ...
                  <span>Ultimo estado backend: {status?.ultimo_estado ?? 'Sin registros'}</span>
                </div>
              </section>
            </div>
