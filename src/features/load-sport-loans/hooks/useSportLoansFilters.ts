...
/**
 * Da formato a los préstamos de deportes que llegan del servidor. La búsqueda
 * (`q`), el filtro (activo/inactivo) y la paginación se resuelven en el
 * backend, por lo que aquí sólo transformamos la página actual.
 */
