            ...
            <div className="summary-cards">
              <div className="summary-card green">
                ...
                <div className="summary-value">
                  {formatCurrency(
                    accountData.installments.reduce((sum, i) => sum + i.total_pagado_mes, 0),
                  )}
                </div>
              ...
              <div className="summary-card yellow">
                ...
                <div className="summary-value">
                  {
                    accountData.installments.filter((i) => i.faltante && i.total_pagado_mes > 0)
                      .length
                  }
                </div>
              ...
              <div className="summary-card red">
                ...
                <div className="summary-value">
                  {formatCurrency(
                    accountData.installments.reduce((sum, i) => sum + i.saldo_pendiente, 0),
                  )}
                </div>
                <div className="summary-desc">
